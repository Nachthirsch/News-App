    ...
    <footer className="bg-white border-t border-gray-100 mt-12">
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col items-center">
          <div className="text-2xl font-bold text-gray-800 mb-4">NewsApp</div>

          <div className="flex space-x-6 mb-6">
            <a href="https://github.com/Nachthirsch" className="text-gray-600 hover:text-blue-500 transition-colors">
            ...
            <a href="https://www.linkedin.com/in/handra-putratama-tanjung" className="text-gray-600 hover:text-blue-500 transition-colors">
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
